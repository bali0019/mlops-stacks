...
class TestParameterConstraints:
    ...
    def test_unity_catalog_parameters_skipped_correctly(self, tmpdir, databricks_cli, unity_catalog):
    ...
    def test_feature_store_mlflow_recipes_constraint(self, tmpdir, databricks_cli):
        ...
        fs_notebook_path = (
            tmpdir / TEST_PROJECT_NAME / TEST_PROJECT_DIRECTORY / 
        ...
        recipe_notebook_path = (
            tmpdir / TEST_PROJECT_NAME / TEST_PROJECT_DIRECTORY /
            "training" / "notebooks" / "TrainWithMLflowRecipes.py"
        )
    ...
    @pytest.mark.parametrize("cicd_platform", ["github_actions", "azure_devops", "gitlab"])
    def test_docker_image_skipped_for_non_gitlab(self, tmpdir, databricks_cli, cicd_platform):
    ...
    def test_workspace_host_parameters_skipped_for_project_only(self, tmpdir, databricks_cli):
